...
if __name__=="__main__":
  ...
  img0 = imageio.imread("/home/young/gum_ws/src/unicontact_real/script/record/test_bluegripper/trajectory/camera_infra1_/000000.png")
  img1 = imageio.imread("/home/young/gum_ws/src/unicontact_real/script/record/test_bluegripper/trajectory/camera_infra2_/000000.png")
  img0 = np.repeat(img0[..., None], 3, axis=-1)
  ...
  with torch.cuda.amp.autocast(True):
    if not args.hiera:
      ...
      dis = model.run_hierachical(img0, img1, iters=args.valid_iters, test_mode=True, small_ratio=0.5)
  ...
  intrinsic_file  = "/home/young/gum_ws/src/unicontact_real/assets/K.txt"
